...
function App() {
  const [activeView, setActiveView] = useState<"home" | "image-to-image" | "image-to-pdf">("home");
      ...
      <div className="curved-frame">
            ...
            <div className="rail-btn-wrapper" ref={popoverRef}>
              ...
              {isToolsPopoverOpen && (
                <div className="rail-popover-box">
                  ...
                  <button
                    className={`tool-item ${activeView === "image-to-pdf" ? "active" : ""}`}
                    type="button"
                    onClick={() => {
        ...
        <main className={`main-viewport view-${activeView}`}>
          ...
          {activeView === "image-to-pdf" && (
            <ImageToPdfConverter isConverting={isConverting} />
          )}
        </main>
      </div>
    </div>
